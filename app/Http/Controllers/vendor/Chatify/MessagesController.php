...
class MessagesController extends Controller
{
    ...
    public function index($id = null)
    {
        ...
        // Ensure $id is a valid conversation that belongs to the authenticated user
        if ($id) {
            $conversation = Chatify::conversations()->where('id', $id)->first();
    
            if (!$conversation || ($conversation->from_id !== $user->id && $conversation->to_id !== $user->id)) {
