                ...
                <form action="{{ route('events.store') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <input type="text" id="start_time" name="start_time" class="mt-2 w-full p-2 border border-gray-300 rounded-lg" value="{{ old('start_time') }}" required>
                        ...
                        <div>
                            ...
                            <input type="text" id="end_time" name="end_time" class="mt-2 w-full p-2 border border-gray-300 rounded-lg" value="{{ old('end_time') }}" required>
                    ...
                    <div class="flex justify-between">
                        <button type="button" onclick="window.history.back()" class="bg-gray-500 hover:bg-gray-700 text-white font-bold py-2 px-4 rounded-lg">
                            Cancel
                        </button>
