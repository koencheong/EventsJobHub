<x-app-layout>
    <x-slot name="header">
        <div class="flex justify-between items-center">
            <h2 class="font-semibold text-xl text-gray-800"> {{ __('Applicant Profile') }} </h2>
        </div>
    </x-slot>
            ...
            <div class="bg-white shadow-xl rounded-2xl p-8 border border-gray-100">
                ...
                <div class="flex items-center justify-between space-x-6 mb-12 border-b border-gray-200 pb-6">
                    <div class="flex items-center space-x-6">
                        <!-- Name and Bio -->
                        <div>
                            <h1 class="text-4xl font-bold text-gray-800">{{ $partTimer->full_name }}</h1>
                            <p class="text-gray-600 mt-2 text-lg">{{ $partTimer->bio ?? 'No bio available' }}</p>
                        </div>
                    </div>
                    <!-- View Ratings Button -->
                    <a href="{{ route('ratings.show', ['userId' => $partTimer->user_id]) }}" 
                        ...
                        <div class="p-6 bg-gray-50 rounded-lg shadow-sm hover:shadow-md transition-shadow">
                            <div class="flex items-center space-x-4">
                                ...
                                <div>
                                    ...
                                    <p class="text-gray-900 text-lg">{{ $partTimer->phone ?? 'Not specified' }}</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="p-6 bg-gray-50 rounded-lg shadow-sm hover:shadow-md transition-shadow">
                            <div class="flex items-center space-x-4">
                                ...
                                <div>
                                    ...
                                    <p class="text-gray-900 text-lg">{{ $partTimer->location ?? 'Not specified' }}</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="p-6 bg-gray-50 rounded-lg shadow-sm hover:shadow-md transition-shadow">
                            <div class="flex items-center space-x-4">
                                ...
                                <div>
                                    ...
                                    <p class="text-gray-900 text-lg">{{ $partTimer->work_experience ?? 'No experience added' }}</p>
                                </div>
                            </div>
                        </div>
                    </div>
