    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white shadow-md sm:rounded-lg p-8">
                ...
                <!-- Pending Jobs -->
                <h3 class="text-xl font-semibold text-gray-800 mb-6">Pending Approval</h3>
                <div class="overflow-hidden rounded-lg shadow-sm mb-8 border border-gray-200">
                ...
                <!-- Approved Jobs -->
                <h3 class="text-xl font-semibold text-gray-800 mb-6">Approved Jobs</h3>
                <div class="overflow-hidden rounded-lg shadow-sm mb-8 border border-gray-200">
                    <table class="min-w-full bg-white rounded-lg">
                        <thead class="bg-gray-100 text-gray-700 uppercase text-sm">
                            <tr>
                                    ...
                                    <tr class="hover:bg-gray-50 transition">
                                        ...
                                        <td class="py-4 px-6 text-center">
                                            <div class="flex justify-center space-x-3">
                                                <a href="{{ route('events.edit', $job) }}" class="bg-blue-500 hover:bg-blue-600 text-white px-3 py-1.5 rounded-lg text-sm">
                                                    Edit
                                                </a>
                                                <a href="{{ route('employer.jobs.applications', $job->id) }}" class="bg-gray-500 hover:bg-gray-600 text-white px-3 py-1.5 rounded-lg text-sm">
                                                    View
                                                </a>
                                                <form action="{{ route('events.destroy', $job) }}" method="POST" onsubmit="return confirm('Are you sure you want to delete this job?');">
                                                    @csrf
                                                    @method('DELETE')
                                                    <button type="submit" class="bg-red-500 hover:bg-red-600 text-white px-3 py-1.5 rounded-lg text-sm">
                                                        Delete
                                                    </button>
                                                </form>
                                            </div>
                ...
                <!-- Completed Jobs -->
                <h3 class="text-xl font-semibold text-gray-800 mb-6">Completed Jobs</h3>
                <div class="overflow-hidden rounded-lg shadow-sm mb-8 border border-gray-200">
                    <table class="min-w-full bg-white rounded-lg">
                        <thead class="bg-gray-100 text-gray-700 uppercase text-sm">
                            <tr>
                            ...
                            @foreach($jobs->where('status', 'approved') as $job)
                                @if($job->applications->where('status', 'paid')->isNotEmpty())
                                    <tr class="hover:bg-gray-50 transition">
                                        ...
                                        <td class="py-4 px-6 text-center">
                                            <div class="flex justify-center space-x-3">
                                                <a href="{{ route('employer.jobs.applications', $job->id) }}" class="bg-green-500 hover:bg-green-600 text-white px-3 py-1.5 rounded-lg text-sm">
                                                    View
                                                </a>
                                            </div>
                                        </td>
                ...
                <!-- Rejected Jobs -->
                <h3 class="text-xl font-semibold text-gray-800 mb-6">Rejected Jobs</h3>
