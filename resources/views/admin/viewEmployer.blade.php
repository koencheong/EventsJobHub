<x-app-layout>
            ...
            <div class="bg-white shadow-xl rounded-2xl p-8 border border-gray-100">
                ...
                <div class="flex items-center justify-between space-x-6 mb-12 border-b border-gray-200 pb-6">
                    <div class="flex items-center space-x-6">
                        ...
                        <div class="w-20 h-20 rounded-full bg-blue-100 flex items-center justify-center">
                            <span class="text-2xl font-bold text-blue-600">{{ substr($employer->name, 0, 1) }}</span>
                        </div>
                        <!-- Employer Name and Industry -->
                        <div>
                            <h1 class="text-4xl font-bold text-gray-800">{{ $employer->name }}</h1>
                            <p class="text-gray-600 mt-2 text-lg">{{ $employer->employerProfile->industry }}</p>
                        </div>
                    </div>
                    <!-- View Ratings Button -->
                    <a href="{{ route('ratings.show', ['userId' => $employer->id]) }}" 
                        ...
                        <div class="p-6 bg-gray-50 rounded-lg shadow-sm hover:shadow-md transition-shadow">
                            <div class="flex items-center space-x-4">
                                ...
                                <div>
                                    ...
                                    <p class="text-gray-900 text-lg">{{ $employer->name }}</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="p-6 bg-gray-50 rounded-lg shadow-sm hover:shadow-md transition-shadow">
                            <div class="flex items-center space-x-4">
                                ...
                                <div>
                                    ...
                                    <p class="text-gray-900 text-lg">{{ $employer->employerProfile->business_email }}</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="p-6 bg-gray-50 rounded-lg shadow-sm hover:shadow-md transition-shadow">
                            <div class="flex items-center space-x-4">
                                ...
                                <div>
                                    ...
                                    <p class="text-gray-900 text-lg">{{ $employer->employerProfile->phone }}</p>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="flex items-center space-x-4">
                                ...
                                <div>
                                    ...
                                    <p class="text-gray-900 text-lg">
                                        <a href="{{ $employer->employerProfile->company_website }}" 
                                           class="text-blue-600 hover:text-blue-700 transition duration-200" 
                                           target="_blank">{{ $employer->employerProfile->company_website }}</a>
                                    </p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="p-6 bg-gray-50 rounded-lg shadow-sm hover:shadow-md transition-shadow">
                            <div class="flex items-center space-x-4">
                                ...
                                <div>
                                    ...
                                    <p class="text-gray-900 text-lg">{{ $employer->employerProfile->company_location }}</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="p-6 bg-gray-50 rounded-lg shadow-sm hover:shadow-md transition-shadow">
                            <div class="flex items-center space-x-4">
                                ...
                                <div>
                                    ...
                                    <p class="text-gray-900 text-lg">{{ $employer->employerProfile->industry }}</p>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="mb-12">
                    ...
                    <div class="bg-white shadow-md rounded-xl p-6 border border-gray-200">
                        @if (!empty($employer->employerProfile->company_location))
    ...
    <script>
        ...
        function initMap() {
            const location = "{{ $employer->employerProfile->company_location }}"; // Get the company location from the profile
